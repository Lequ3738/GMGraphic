...
> [!Warning]
您正在查看**主分支 (master)**的说明文件，可能包含未发布的功能。对于特定版本，请选择对应标签。
...
- 更多的**渲染控制**，**多重纹理**和**扩展图元**。
- 基于**纹理图集**的图像绘制功能。应用于各大主流游戏引擎，能有效减少 DrawCall 开销。
...
❌ 纹理图集的保存与读取<br>
✅ 基于自动提交的类原生绘制 API<br>
✅ 更高效和更多样的字体绘制功能，支持任意缩放字形和改变字形的粗细度(可精确到小数)，加载快且占用内存少，以及更多样的渲染控制选项。<br>
❌ 绘制文字时支持简单的标记(类似 BBCode)<br>
